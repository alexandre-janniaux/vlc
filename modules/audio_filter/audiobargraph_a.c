...
static int Open( vlc_object_t *p_this )
{
    ...
    var_Create(p_filter->obj.members.libvlc, "audiobargraph_v-alarm", VLC_VAR_BOOL);
    var_Create(p_filter->obj.members.libvlc, "audiobargraph_v-i_values", VLC_VAR_STRING);
...
static void SendValues(filter_t *p_filter, float *value, int nbChannels)
{
    ...
    var_SetString(p_filter->obj.members.libvlc, "audiobargraph_v-i_values", msg);
}
...
static block_t *DoWork( filter_t *p_filter, block_t *p_in_buf )
{
    ...
    if (p_sys->silence) {
        ...
        if (p_sys->started && p_in_buf->i_pts > p_sys->lastAlarm + p_sys->repetition_time) {
            ...
            var_SetBool(p_filter->obj.members.libvlc, "audiobargraph_v-alarm",
...
static void Close( vlc_object_t *p_this )
{
    ...
    var_Destroy(p_filter->obj.members.libvlc, "audiobargraph_v-i_values");
    var_Destroy(p_filter->obj.members.libvlc, "audiobargraph_v-alarm");
