...
- (void)dealloc;
- (void)didMoveToWindow:(UIView*)subview;
...
/* Renderers are expected to fill the whole frame so tell the compositor
 * that he doesn't have to bother with what's behind the window. */
- (BOOL)isOpaque { return YES; }

/* Prevent the subviews (which are renderer) to get events so that
 * they can be dispatched from a vout_window module. */
