...
static int Control(vout_display_t *vd, int query, va_list ap)
{
    ...
    case VOUT_DISPLAY_CHANGE_ZOOM: {
        ...
        /* The following resize should be automatic but can trigger bugs on some
         * platform with some drivers, especially on Windows.
         * Doing it right now force the correct behavior and prevent these bugs.
         * In any case, the swapchain creation wont be done twice. */
