...
typedef struct
{
    ...
    union
    {
        struct
        {
            ...
            struct vlc_android_surfacetexture *surfacetexture;
        } video;
        struct {
            date_t i_end_date;
            int i_channels;
...
CreateVideoContext(decoder_t *p_dec)
{
    ...
    {
        p_sys->video.surfacetexture = vlc_android_surfacetexture_New(awh);
        p_sys->video.p_surface = vlc_android_surfacetexture_GetANativeWindow(p_sys->video.surfacetexture);
        p_sys->video.p_jsurface = vlc_android_surfacetexture_GetSurface(p_sys->video.surfacetexture);
    }
    else
    {
