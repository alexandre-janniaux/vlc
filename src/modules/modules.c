                          ...
                          vlc_activate_t probe, ...)
{
    ...
    const bool b_force_backup = obj->obj.members.force; /* FIXME: remove this */
    va_list args;
    ...
    while (*name)
    {
        ...
        obj->obj.members.force = strict && strcasecmp ("any", shortcut);
    ...
    va_end (args);
    obj->obj.members.force = b_force_backup;
    module_list_free (mods);
